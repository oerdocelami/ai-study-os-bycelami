      ...
      <div className="relative z-10">
        ...
        <div className="px-8 pt-12 pb-8 border-b border-slate-700/30">
          <div className="max-w-6xl mx-auto">
            <div className="mb-2 text-sm font-medium text-violet-400 tracking-wider uppercase">
              Study Materials
            </div>
        ...
        <div className="px-8 py-12">
          <div className="max-w-4xl mx-auto">
            ...
            <div
              ...
              onDrop={handleDrop}
              className={`relative overflow-hidden rounded-2xl border-2 border-dashed transition-all duration-300 p-12 text-center cursor-pointer ${
                dragActive
              ...
              <div className="relative z-10">
                ...
                <label className="inline-block">
                  ...
                  <button
                    ...
                    disabled={uploading}
                    className="bg-gradient-to-r from-violet-500 to-purple-500 hover:from-violet-600 hover:to-purple-600 disabled:from-slate-600 disabled:to-slate-600 text-white font-semibold px-8 py-3 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl disabled:cursor-not-allowed"
                  >
            ...
            {pdfs.length > 0 && (
              <div className="mt-12">
                <h2 className="text-2xl font-bold text-white mb-6">Your PDFs</h2>
                <div className="space-y-3">
                  {pdfs.map((pdf) => (
                    <div
                      key={pdf.id}
                      className="group relative overflow-hidden rounded-xl bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl border border-slate-700/50 p-6 hover:border-violet-500/50 transition-all duration-300"
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          <a
                            ...
                            className="flex items-center gap-2 px-4 py-2 bg-slate-700/30 hover:bg-slate-600/50 text-white rounded-lg transition-all"
                          >
                          ...
                          <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 bg-red-500/10 hover:bg-red-500/20 text-red-400 rounded-lg transition-all opacity-0 group-hover:opacity-100"
                          >
